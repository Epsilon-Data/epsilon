...
atlas.graph.storage.clustername=epsilon
atlas.graph.storage.port=9042
atlas.graph.storage.username=epsilon
atlas.graph.storage.password=${CASSANDRA_EPSILON_PASSWORD}
...
#########  Import Configs  #########
# atlas.import.temp.directory=/tmp/import

#########  Index Recovery Configs  #########
# atlas.index.recovery.enable=false
atlas.index.recovery.start.time=2025-07-11T00:00:00.000Z
...
# SSL config
atlas.enableTLS=${ATLAS_TSL_ENABLED}
...
# atlas.authentication.method.keycloak.file=${ATLAS_HOME}/conf/keycloak.json
